...
const categories = ['Crisis', 'Mental Health Support', 'Personal Support'];
...
const articles = [
  ...
  {
    title: 'Managing Our Emotions',
    desc: 'Practical strategies for understanding and regulating your emotions during stressful periods — from HealthHub Singapore.',
    url: 'https://www.healthhub.sg/programmes/mindsg/caring-for-ourselves/managing-our-emotions-adults#home',
  },
];
    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="px-8 pb-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Wellness Reads</h2>
            <div className="flex flex-col gap-3">
              {articles.map((a) => (
        ...
        {/* Right — Helplines + Online Support */}
        <div className="flex flex-col gap-5">
          <div>
            <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Helplines</h2>
          ...
          <div>
            <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Online Support</h2>
            <div className="flex flex-col gap-3">
              <a href="https://mindline.sg" target="_blank" rel="noreferrer"
                className="bg-white rounded-2xl p-4 shadow-sm flex justify-between items-center hover:shadow-md transition-shadow">
                <div>
                  <p className="font-medium text-gray-800">MindLine.sg</p>
                  <p className="text-xs text-gray-500 mt-0.5">Free online mental health self-assessment & resources by IMH</p>
                </div>
                <span className="text-zen-500 text-sm font-medium">→</span>
              </a>
              <a href="https://www.samhealth.org.sg/about-samh/contact-us-2/" target="_blank" rel="noreferrer"
                className="bg-white rounded-2xl p-4 shadow-sm flex justify-between items-center hover:shadow-md transition-shadow">
                <div>
                  <p className="font-medium text-gray-800">SAMH Contact & Services</p>
                  <p className="text-xs text-gray-500 mt-0.5">Reach the Singapore Association for Mental Health for support</p>
                </div>
                <span className="text-zen-500 text-sm font-medium">→</span>
              </a>
            </div>
